...
<head>
    ...
    <meta content="Premium Multipurpose {{ asset('admin & Dashboard Template') }}" name="description" />
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ url('/storyCreateupdate/' . $event->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf 
                                            <div class="row gy-4">
                                                <div class="col-md-6">
                                                    <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <textarea class="form-control" rows="5" id="location" name="location">{{$event->location}}</textarea>
                                                    </div>
                                                    <div>
                                                    ...
                                                    <div>
                                                        <label for="basiInput" class="form-label">Event Poster</label>
