                                ...
                                <div class="row">
                                    ...
                                    <div class="card">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">View Events</h4>
                                            </div>
                                            <div class="card-header align-items-center d-flex">
                                            <a href="/addEvent" type="submit" class="btn btn-primary" id="basiInput"> Add Event</a>
                                            </div>
                                            <div class="card-body">
                                                    ...
                                                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <td><img style="width: 100px; height: 80px;" src="{{ asset('storage/' . $value->image_url) }}" alt="Story Image">
                                                             ...
                                                             <td>
                                                             <a href="{{ url('/showEvent', ['id' => $value->id]) }}">
                                                                 <button class="btn btn-primary">
                                                                    Edit
                                                                </button>
                                                            </a>
                                                            <a href="{{ url('/destroyEvent', ['id' => $value->id]) }}">
