                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Story</h4>
                                </div>
                                <div class="card-body">
                                    <div class="live-preview">
                                    <form action="{{ url('/storyUpdatebyId/' . $story->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf 
                                            <div class="row gy-4">
                                                <div class="col-md-6">
                                                <input class="form-control" type="hidden" id="id" name="id" value="{{$story->id}}">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <label for="basiInput" class="form-label">Select Categories</label>
                                                        <select class="form-control" name="categories_id" id="categories_id" value="{{$story->categories}}">
                                                            <option value="1">Volvo</option>
                                                        </select>
                                                    </div>
                                                    <div>
                                                        <label for="basiInput" class="form-label">Image Uplode</label>
...
<!-- Mirrored from themesbrand.com/velzon/html/master/forms-elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Dec 2024 13:53:52 GMT -->
</html>