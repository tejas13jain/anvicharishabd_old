...
<!-- Mirrored from themesbrand.com/velzon/html/master/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Dec 2024 13:50:49 GMT -->
<head>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="/adminDashboard">
                                <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Dashboards</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                                <i class="ri-apps-2-line"></i> <span data-key="t-apps">Story</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="/viewstory" class="nav-link">
                                            View Story
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/viewCateogries" class="nav-link" data-key="t-chat"> View Categories </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/viewEvent" class="nav-link" data-key="t-chat"> View Events </a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="/viewSetting">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                        <div class="flex-grow-1">
                                            <h4 class="fs-16 mb-1">Hey, Nisarg!</h4>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <p class="text-uppercase fw-medium text-muted text-truncate mb-0"> Total Story</p>
                                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="card">
                                        <div class="card-header align-items-center d-flex">
                                            <h4 class="card-title mb-0 flex-grow-1">View Story</h4>
                                        </div>
                                        <div class="card-header align-items-center d-flex">
                                        <a href="/story" type="submit" class="btn btn-primary"> Add Story</a>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive table-card">
                                                <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td>{{$value->content}}></td>
                                                        <td><img style="width: 100px; height: 80px;" src="{{ asset('storage/' . $value->image_url) }}" alt="Story Image">
                                                        </td>
                                                        <td>
                                                        <a href="{{ url('/show', ['id' => $value->id]) }}">
                                                            <button class="btn btn-primary">
                                                            Edit
                                                            </button>
                                                            <a href="{{ url('/destroyStory', ['id' => $value->id]) }}">
...
<!-- Mirrored from themesbrand.com/velzon/html/master/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Dec 2024 13:51:50 GMT -->
</html>