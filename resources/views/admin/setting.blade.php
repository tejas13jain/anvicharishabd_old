                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ url('/settingCreateupdate/' . $data->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf 
                                            <div class="row gy-4">
                                                <div class="col-md-6">
                                                    <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" id="insta" name="insta" value="{{$data->insta}}">
                                                    </div>
                                                    <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input class="form-control" type="file" id="logo" name="logo" value="{{$data->logo}}">
                                                    </div>
                                                </div>
                                                    <div>
